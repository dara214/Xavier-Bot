...
module.exports = {
    ...
    async execute(message, args) {
        let tosEmbed = new Discord.MessageEmbed()
            ...
            .addField('**3.** Custom Commands', 'Some commands that you may see on our [support server](dsc.gg/titanbots)')
